...
function generateReturningUsersData() {
  let usersData = {};
  ...
  // filter for users who have more than one activity
  const returningUsers = Object.entries(usersData)
...
const returningUsersData = generateReturningUsersData();
